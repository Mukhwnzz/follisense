...
export const consumerConditions: ConsumerCondition[] = [
  {
    ...
    actionSteps: [
      ...
      'Give your hair breaks between protective styles (at least 1 to 2 weeks)',
  ...
  },
  {
    ...
    whenToSee: "If over-the-counter medicated shampoos aren't helping after 2 to 3 weeks, see a dermatologist for a prescription-strength treatment.",
  ...
  },
  {
    ...
    whenToSee: "If the bumps are spreading, painful, pus-filled, or don't clear up within 1 to 2 weeks, see a doctor.",
    relatedArticleId: undefined,
