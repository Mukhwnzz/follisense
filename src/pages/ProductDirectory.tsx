...
const productDirectory: ProductCategory[] = [
  {
    ...
    products: [
      ...
      { name: 'Rosemary oil', desc: 'Stimulates circulation and may support hair growth', tag: 'Scalp' },
      { name: 'Castor oil (including JBCO)', desc: 'Thick moisturising oil often used to support edge growth', tag: 'Scalp' },
  ...
  },
  {
    ...
    products: [
      { name: 'Minoxidil (e.g., Rogaine)', desc: 'FDA-approved topical treatment for hair regrowth', tag: 'Scalp' },
      ...
      { name: 'Pyrithione zinc shampoo', desc: 'Anti-dandruff shampoo that reduces flaking and itching', tag: 'Scalp' },
  ...
  },
  {
    ...
    products: [
      { name: 'Argan oil', desc: 'Lightweight oil that adds shine and reduces frizz', tag: 'Hair' },
  ...
  },
  {
    ...
    products: [
      { name: 'Edge control (gel-based)', desc: 'Holds edges in place with a smooth finish', tag: 'Hair' },
      { name: 'Edge control (wax-based)', desc: 'Stronger hold for edges, can cause buildup', tag: 'Hair' },
      { name: 'Styling gel (flaxseed, aloe-based)', desc: 'Natural hold for wash-and-gos and twist-outs', tag: 'Hair' },
      { name: 'Mousse', desc: 'Lightweight hold and volume for curls and coils', tag: 'Hair' },
      { name: 'Curl cream', desc: 'Defines curls while adding moisture', tag: 'Hair' },
  ...
  },
  {
    ...
    products: [
      { name: 'Deep conditioner (moisture-based)', desc: 'Intense hydration for dry, brittle hair', tag: 'Hair' },
      { name: 'Deep conditioner (protein-based)', desc: 'Strengthens hair structure and reduces breakage', tag: 'Hair' },
      { name: 'Leave-in conditioner', desc: 'Daily moisture and detangling for hair', tag: 'Hair' },
      { name: 'Protein treatment (e.g., Aphogee)', desc: 'Reconstructs damaged hair with protein bonds', tag: 'Hair' },
      { name: 'Bond repair treatment (e.g., Olaplex)', desc: 'Repairs disulfide bonds damaged by chemicals or heat', tag: 'Hair' },
