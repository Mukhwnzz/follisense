  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-6">
      ...
      >
        ...
        <h1 className="text-2xl font-semibold text-foreground text-center mb-8">Create your account</h1>
        ...
        <div className="space-y-3 mb-8">
          <button onClick={() => { setUserName('Ama'); navigate('/onboarding'); }} className="w-full h-12 rounded-xl border-2 border-border bg-card text-foreground text-sm font-medium flex items-center justify-center gap-3 btn-press">
